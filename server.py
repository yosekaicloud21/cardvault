...
class CardIndexDB:
    ...
    def index_card(self, filepath: str) -> Optional[CardEntry]:
        ...
        if should_quarantine:
            # Log to quarantine for manual review - NEVER auto-delete
    ...
    <div class="container">
        ...
        <div id="quarantine" class="tab-content">
            <div class="section">
                ...
                <button class="btn btn-danger" onclick="deleteAllQuarantine()" id="delete-all-quarantine-btn" style="margin-bottom:15px;display:none;">Delete All</button>
    ...
    <script>
        ...
        async function loadQuarantine() {
            ...
            try {
                ...
                // Add Delete All button before the list
                            ...
                            <div style="margin-bottom:10px;">
                                <a href="${imageUrl}" target="_blank" style="display:block;">
                                    <img src="${imageUrl}" style="width:100%;height:200px;object-fit:cover;border-radius:8px;cursor:pointer;" 
                                         onerror="this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22200%22 height=%22200%22%3E%3Crect fill=%22%23ddd%22 width=%22200%22 height=%22200%22/%3E%3Ctext x=%2250%25%22 y=%2250%25%22 text-anchor=%22middle%22 fill=%22%23999%22%3ENo Image%3C/text%3E%3C/svg%3E'">
                                </a>
                            </div>
